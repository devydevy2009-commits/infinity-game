...
(() => {
  ...
  // These firing drones are only the visible sources for the existing barrage.
  // The real boss carriers, their orbiting drones and their HP bars are rendered
  // by boss_system.js, so there is only one carrier visual in the scene.
